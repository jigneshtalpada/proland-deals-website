...
const Property = () => {
  return (
    <div
      className="property-listing-one  mt-150 xl-mt-120 pt-140 xl-pt-120 lg-pt-80 pb-180 xl-pb-120 lg-pb-100"
      style={{ background: "#ffb180" }}
    >
                ...
                <div key={item.id} className="col-lg-4 col-md-6 d-flex mt-40">
                  <div className="listing-card-one border-25 h-100 w-100">
                    ...
                    <div className="property-info p-25">
                      <Link to="/listing_details_01" className="title tran3s">
                        {item.title}
                      </Link>
