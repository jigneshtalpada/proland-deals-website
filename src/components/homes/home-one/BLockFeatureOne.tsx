   ...
   return (
      <div className="block-feature-one mt-130 xl-mt-100 lg-mt-80 mb-150 xl-mb-100 lg-mb-80">
         <div className="container">
            <div className="title-one text-center mb-50 xl-mb-30 lg-mb-20">
               <h3>Unlock Homy&apos;s <span>advantages <img src="/assets/images/shape/title_shape_01.svg" alt="" className="lazy-img" /></span></h3>
               ...
               {feature_data.filter((items) => items.page === "home_1_feature_1").map((item) => (
                  <div key={item.id} className="col-md-4">
                     <div className="card-style-one text-center mt-40">
                        <img src={item.icon ? item.icon : ""} alt="" className="lazy-img m-auto icon" />
