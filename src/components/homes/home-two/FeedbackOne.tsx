...
const Feedback = () => {
   return (
      <div className="feedback-section-two md-pb-40 position-relative z-1">
                  ...
                  <div className="main-content position-relative z-1">
                     <div className="feedback-block-two">
                        ...
                        <div className="d-flex align-items-center mt-75 md-mt-60">
                           <img src="/assets/images/media/img_01.jpg" alt="" className="rounded-circle avatar" />
                           <div className="ps-4">
                              <h6 className="fs-22 text-white fw-normal mb-5">James Bond.</h6>
                              <span className="text-white opacity-50 fw-light">CEO & Head of Proland Deals Inc</span>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <img src="/assets/images/shape/shape_14.svg" alt="" className="lazy-img shapes shape_01" />
         <img src="/assets/images/shape/shape_15.svg" alt="" className="lazy-img shapes shape_02" />
      </div>
   )
}
