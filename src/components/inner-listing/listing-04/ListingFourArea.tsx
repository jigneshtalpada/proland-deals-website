         ...
         <div className="container">
            ...
            <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
               ...
               <div className="d-flex align-items-center xs-mt-20">
                  ...
                  <Link to="/listing_03" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></Link>
               </div>
            </div>

            {currentItems.map((item: any) => (
               <div key={item.id} className="listing-card-seven border-20 p-20 mb-50">
                  <div className="d-flex flex-wrap layout-one">
                     ...
                     <div className="property-info">
                        <Link to="/listing_details_04" className="title tran3s mb-15">{item.title}</Link>
                        ...
                        <div className="pl-footer d-flex flex-wrap align-items-center justify-content-between">
                           ...
                           <Link to="/listing_details_04" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                        </div>
                     </div>
                  </div>
               </div>
