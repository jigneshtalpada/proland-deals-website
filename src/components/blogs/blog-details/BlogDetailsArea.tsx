            ...
            <div className="row gx-xl-5">
               <div className="col-lg-8">
                  <div className="blog-post-meta mb-60 lg-mb-40">
                     <div className="post-info"><Link to="/blog_02">Rashed Kabir .</Link> 6 min</div>
                     <h3 className="blog-title">{blog?.title ? blog.title : title_1}</h3>
                  </div>
               </div>
            </div>
            <div className="row gx-xl-5">
                  ...
                  <article className="blog-post-meta">
                     ...
                     <div className="post-data pt-50 md-pt-30">
                        ...
                        <div className="quote-wrapper">
                           <div className="icon rounded-circle d-flex align-items-center justify-content-center m-auto">
                              <img src="/assets/images/icon/icon_67.svg" alt="" className="lazy-img" /></div>
                           <div className="row">
                        ...
                        <p>{desc_5}</p>
                        <div className="img-meta"><img src="/assets/images/blog/blog_img_16.jpg" alt="" className="lazy-img w-100" /></div>
                     ...
                     <div className="bottom-widget d-sm-flex align-items-center justify-content-between">
                        ...
                        <ul className="d-flex share-icon align-items-center style-none pt-20">
                           <li>Share:</li>
                           {icon.map((icon, index) => (
                              <li key={index}><Link to="#"><i className={icon}></i></Link></li>
                           ))}
                        </ul>
                     </div>
                  </article>
